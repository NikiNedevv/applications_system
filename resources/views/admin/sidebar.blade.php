<div class="span3">
    <div class="sidebar">
        <ul class="widget widget-menu unstyled">
            ...
            <li><a href="{{ route('specialities.index') }}"><i class="menu-icon icon-inbox"></i>Inbox <b class="label green pull-right">
            11</b> </a></li>
        ...
        <ul class="widget widget-menu unstyled">
            <li><a href="{{ route('specialities.index') }}"><i class="menu-icon icon-bold"></i> Specialities </a></li>
